...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 px-4 py-4 md:py-6">
      <div className="mx-auto flex min-h-screen max-w-4xl flex-col gap-6">
        ...
        <header className="space-y-2">
          ...
          <p className="text-sm text-gray-400 max-w-2xl">
            ...
            para iniciar el análisis bajo los marcos de Actividades
            Rutinarias, Patrón Delictivo, Elección Racional y Ventanas Rotas.
          </p>
        </header>
